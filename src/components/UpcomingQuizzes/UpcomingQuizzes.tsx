...
const UpcomingQuizzes: React.FC = () => {
  ...
  return (
    <div className="bg-white shadow-md rounded-xl p-6  w-full mx-auto   border">
          ...
          {quizzesWithStudents.map((quiz) => {
            ...
            return (
              ...
              >
                ...
                {/* Status */}
         <div
  className="flex items-center gap-2 font-medium px-2  cursor-pointer"
  onClick={() =>
    navigate(`/dashboard/quizdetails/${quiz._id}`, { state: { quiz } })
  }
>
  <span className="text-black">Open</span>
  <div className="bg-[#C5D86D] mt-1 rounded-full p-1 flex items-center justify-center py-1">
